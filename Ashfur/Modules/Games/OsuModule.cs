...
//     public async Task StandardMode(SlashCommandContext context, [SlashCommandParameter(Name = "player", Description = "Username of said osu! player")] string player) {
...
//                 m.AddComponents(ComponentUtils.BuildExceptionComponent("Could not fetch Osu data!", e))));
//             throw;
//         }
//
//
